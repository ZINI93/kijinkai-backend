...
class DeliveryServiceImplTest {
    ...
    void createDeliveryWithValidate_Success() {
        ...
        given(addressRepository.findByCustomerCustomerUuid(customer.getCustomerUuid())).willReturn(Optional.of(address));
    ...
    void createDeliveryWithValidate_AddressNotFound() {
        ...
        given(addressRepository.findByCustomerCustomerUuid(customer.getCustomerUuid()))
                .willReturn(Optional.empty());
    ...
    void deliveryShipped_Success() {
        ...
        given(customerRepository.findByUserUserUuid(userUuid)).willReturn(Optional.of(customer));
        given(deliveryRepository.findByCustomerCustomerUuidAndDeliveryUuid(customer.getCustomerUuid(), deliveryUuid)).willReturn(Optional.of(delivery));
        given(deliveryMapper.toResponse(delivery)).willReturn(responseDto);
    ...
    void deliveryShipped_CustomerNotFound() {
        ...
        given(customerRepository.findByUserUserUuid(userUuid)).willReturn(Optional.empty());
    ...
    void deleteDelivery_Success() {
        ...
        given(customerRepository.findByUserUserUuid(userUuid))
                .willReturn(Optional.of(customer));
        given(deliveryRepository.findByCustomerCustomerUuidAndDeliveryUuid(
    ...
    void getDeliveryInfo_Success() {
        ...
        verify(customerRepository).findByUserUserUuid(userUuid);
        verify(deliveryRepository).findByCustomerCustomerUuidAndDeliveryUuid(
                customer.getCustomerUuid(), deliveryUuid);
