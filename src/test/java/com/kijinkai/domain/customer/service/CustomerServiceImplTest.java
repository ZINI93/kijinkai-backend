...
//        when(customerRepository.findByUserUuidAndCustomerUuid(user.getUserUuid(),customer.getCustomerUuid())).thenReturn(Optional.ofNullable(customer));
...
//
//        verify(customerRepository,times(1)).findByUserUuidAndCustomerUuid(user.getUserUuid(),customer.getCustomerUuid());
//        verify(customerMapper,times(1)).toResponse(customer);
//    }
//
//    @Test
...
//        //given
//        when(customerRepository.findByUserUuid(user.getUserUuid())).thenReturn(Optional.ofNullable(customer));
//        when(customerMapper.toResponse(customer)).thenReturn(responseDto);
//
//        //when
...
//
//        verify(customerRepository,times(1)).findByUserUuid(user.getUserUuid());
//        verify(customerMapper,times(1)).toResponse(customer);
//    }
//
////    @Test
