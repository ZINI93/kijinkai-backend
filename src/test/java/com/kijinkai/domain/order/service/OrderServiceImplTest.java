...
class OrderServiceImplTest {
    ...
    void cancelOrder() {
        ...
        OrderResponseDto cancelResponse = OrderResponseDto.builder().orderUuid(order.getOrderUuid()).orderstate(OrderStatus.CANCEL).build();
        ...
        assertNotNull(result);
        assertEquals(order.getOrderUuid(),result.getOrderUuid());
        assertEquals(OrderStatus.CANCEL, result.getOrderstate());
