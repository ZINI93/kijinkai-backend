...
class AddressServiceImplTest {
    ...
    void createAddressWithValidate() {
        ...
        when(customerRepository.findByUserUserUuid(userUuid)).thenReturn(Optional.ofNullable(customer));
        ...
        verify(customerRepository,times(1)).findByUserUserUuid(userUuid);
    ...
    void updateAddressWithValidate() {
        ...
        when(customerRepository.findByUserUserUuid(userUuid)).thenReturn(Optional.ofNullable(customer));
        when(addressRepository.findByCustomerCustomerUuidAndAddressUuid(customer.getCustomerUuid(),addressUuid)).thenReturn(Optional.ofNullable(address));
        when(addressMapper.toResponse(address)).thenReturn(response);
        ...
        verify(customerRepository,times(1)).findByUserUserUuid(userUuid);
        verify(addressRepository,times(1)).findByCustomerCustomerUuidAndAddressUuid(customer.getCustomerUuid(),addressUuid);
    }
