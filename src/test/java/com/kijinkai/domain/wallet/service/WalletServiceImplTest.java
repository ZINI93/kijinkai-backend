...
class WalletServiceImplTest {
    ...
    void deposit() {
        ...
        when(walletRepository.findByCustomerCustomerUuidAndWalletUuid(eq(customerUuid), eq(walletUuid))).thenReturn(Optional.of(initialWallet));
    ...
    void withdrawal() {
        ...
        when(walletRepository.findByCustomerCustomerUuidAndWalletUuid(customerUuid, walletUuid)).thenReturn(Optional.ofNullable(initialWallet));
...
//    }
    ...
    void getWalletBalance() {
        ...
        when(walletRepository.findByCustomerCustomerUuidAndWalletUuid(customerUuid, UUID.fromString(walletUuid))).thenReturn(Optional.ofNullable(wallet));
        when(walletMapper.toResponse(wallet)).thenReturn(response);
        //When
        ...
        verify(walletRepository, times(1)).findByCustomerCustomerUuidAndWalletUuid(customerUuid, UUID.fromString(walletUuid));
    }
