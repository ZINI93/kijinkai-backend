...
public class PaymentController {
    ...
    @PutMapping("/admin/deposit/{requestUuid}/approve")
    ...
    public ResponseEntity<BasicResponseDto<DepositRequestResponseDto>> approveDeposit(
        ...
        try {
            DepositRequestResponseDto response = paymentUseCase.approveDepositRequest(requestUuid, userUuid, memo);
    ...
    @PutMapping("/admin/withdraw/{requestUuid}/approve")
    @PreAuthorize("hasRole('Admin')")
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "입금 처리 성공"),
            @ApiResponse(responseCode = "400", description = "잘못된 요청"),
    ...
    public ResponseEntity<BasicResponseDto<WithdrawResponseDto>> approveWithdraw(
        ...
        try {
            WithdrawResponseDto response = paymentUseCase.approveWithdrawRequest(requestUuid, userUuid, memo);
