package com.kijinkai.domain.wallet.adapter.out.persistence.entity;
...
@Entity
public class WalletJpaEntity extends BaseEntity {
...
//    private Customer customer;
    ...
    @Builder
    public WalletJpaEntity(UUID walletUuid, UUID customerUuid, BigDecimal balance, Currency currency, WalletStatus walletStatus, String freezeReason, Long version) {
    ...
    public WalletJpaEntity freeze(WalletFreezeRequest request){
    ...
    public WalletJpaEntity unfreeze(){
