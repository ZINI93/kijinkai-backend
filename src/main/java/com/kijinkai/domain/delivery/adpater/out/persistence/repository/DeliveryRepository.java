...
public interface DeliveryRepository extends JpaRepository<DeliveryJpaEntity, Long>, DeliveryRepositoryCustom{

    Optional<DeliveryJpaEntity> findByCustomerUuidAndDeliveryUuid(UUID customerUuid, UUID deliveryUuid);
    Optional<DeliveryJpaEntity> findByDeliveryUuid(UUID deliveryUuid);
